...
LOGIN_RATE_LIMIT = os.getenv("LOGIN_RATE_LIMIT", "100/hour")
BOOKING_RATE_LIMIT = os.getenv("BOOKING_RATE_LIMIT", "200/hour")
BROWSING_RATE_LIMIT = os.getenv("BROWSING_RATE_LIMIT", "1000/hour")
